    ...
    <v-container>
      <transition name="fade">
        ...
        <v-row justify="center">
          <v-col cols="12" md="10">
            <h3 class="my-3 display-1">My Skills</h3>
            <div class="">
              <template v-for="(skill, i) in mySkills">
                <v-avatar
                  size="50"
                  color="primary"
                  :key="i" dark
...
export default {
  computed: {
    ...
    mySkills(){
      return [
        'nodejs',
        'language-javascript', 'language-php', 'vuejs', 'firebase', 'jquery', 'language-html5', 'language-css3',
        'wordpress', 'vuetify', 'database'
      ]
    },
    projects() {
      return [
        {name: 'Voteryte', link: 'https://voteryte.com',
          about: 'Decentralized voting app built on the blockchain'
        },
        {name: 'Hotelsmart', link: 'https://hotelsmart.com.ng',
          about: 'Online OTA and Hotel management system'
        },
        {
          name: 'Docuhelp',
          link: 'https://github.com/godwwinpeace22/docuhelp',
          about: 'Free and opensource knowledgebase/self-service widget in Javascript with Markdown support.'
        },
        {
          name: 'Nigerian cities and attraction',
          link: 'https://www.npmjs.com/package/nigerian-cities-and-attractions',
          about: 'An api to get a comprehensive list of major cities in Nigeria and their attractions',
        },
        {
          name: 'QView.ai',
          link: 'https://qview.ai',
